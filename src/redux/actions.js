import { ALL_VIDEOGAMES, ALL_GENRES, ALL_PLATFORMS, GAME_BY_NAME, GAME_BY_ID, CREATE_GAME, CLEAR_DETAIL, 
    CLEAR_SEARCH, CLEAR_FILTER, FILTER_BY_ORIGIN, FILTER_BY_GENRE, ORDER_BY_NAME, ORDER_BY_RATING, FILTER_BY_PLATFORMS } from "./actio3001nTypes";
...
export function getAllGenres () {
    return function (dispatch) {
        return fetch ('https://videogames-backend.vercel.app/genres')
        .then (response => response.json())
...
export function getAllPlatforms () {
    return function (dispatch) {
        return fetch ('https://videogames-backend.vercel.app/platforms')
        .then (response => response.json())
